...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/02/13 17:07:28 by tweimer           #+#    #+#             */
/*   Updated: 2022/02/13 17:08:11 by tweimer          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "pipex.h"

int	ft_gets_count_words(char const *s, char c)
{
	unsigned int		count;
	unsigned int		i;
...
int	ft_write_split(char **dest, char *str, char c, int word_number)
{
	int	i;
	int	j;
	int	a;
